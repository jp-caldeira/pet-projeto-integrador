...
<body>
    ...
    <a href="{{ route('homepage') }}"><img  class=img1 src="/img/logo1.png" alt="logo"></a>
        ...
        <a href="{{ route('cadastropet') }}"button class="tablink" onclick="openPage('Cadastro', this, 'white')">Cadastro Pet</button></a>
        ...
        <a href="{{ route('register') }}"button class="tablink" onclick="openPage('Adote', this, 'white')">Registrar-se</button></a>
