...
$factory->define(ProdutoModel::class, function (Faker $faker) {
    return [
      "nome" => $faker->randomElement([
        ...
        'Ração para gatos de médio porte',
        'Cama para gatos',
        'Cama para cachorros',
        'Ração diet para gatos',
        'Ração Vegana',
        'Ração diet para cachorros',
      ...
      "tipo_produto" => $faker->randomElement(["ração", "brinquedo", "petisco", "higiene e bem-estar"]),
      "categoria" => $faker->randomElement(["cachorro", "gato", "aves", "tartaruga"]),
      "marca" => $faker->company,
