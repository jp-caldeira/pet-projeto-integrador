...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" required>
                        ...
                        <div class="form-group row">
                            <label for="genero" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Genero')); ?></label>
                            <div class="col-md-6">
                                    <select name="genero"class="form-control" value="<?php echo e(old('genero')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="cpf" value="<?php echo e(old('cpf')); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pet-projeto-integrador\pet-pi-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>